...
const AboutSection = () => {
  return (
    <section
      id="about"
      className="w-full h-screen bg-white py-32 flex flex-col items-center justify-center text-center px-6"
    >
      {/* Video */}
      {/* Glass video capsule */}
      <div
...
"
  ...
  "
      ...
      {/* Description */}
      <p className="mt-6 max-w-3xl text-lg text-gray-500 leading-relaxed">
